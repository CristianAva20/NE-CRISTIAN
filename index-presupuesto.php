<?php
	/* Connect To Database*/
	require_once ("presupuesto_trabajo/config/db.php");//Contiene las variables de configuracion para conectar a la base de datos
	require_once ("presupuesto_trabajo/config/conexion.php");//Contiene funcion que conecta a la base de datos
...
<head>
    ...
    <link href="presupuesto_trabajo/assets/css/bootstrap.css" rel="stylesheet" />
    <!-- CUSTOM STYLE CSS -->
    
    <link href="presupuesto_trabajo/assets/css/style.css" rel="stylesheet" />
       ...
       <form class="form-horizontal" role="form" id="datos_presupuesto" method="post">
        <div id="print-area">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4">
                  <a href="https://obedalvarado.pw/" target="_blank">  <img src="presupuesto_trabajo/assets/img/logo.png" alt="Logo sistemas web" /></a>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4">
...
<br><br>
            <div class="col-lg-12 col-md-12 col-sm-12">
                <button type="button" class="btn btn-success "><a href="starter-crud-pre.php" class="btn btn__nuevo">Ver presupuestos</a></button>                
            </div>
<br><br><br>
            <div class="col-lg-12 col-md-12 col-sm-12">
                <button type="submit" class="btn btn-success "><a href="starter.php" class="btn btn__nuevo">Regresar</a></button>                
            </div>
	...
	<div>
		...
		<a href="crud.drive/insert.php" >Nuevo</a>
	...
	<script type="text/javascript" src="presupuesto_trabajo/js/VentanaCentrada.js"></script>
...
$(document).ready(function() {
    $( ".cliente" ).select2({        
    ajax: {
        url: "presupuesto_trabajo/ajax/clientes_json.php",
        dataType: 'json',
        delay: 250,
	...
	function mostrar_items(){
		...
		$.ajax({
			url:'presupuesto_trabajo/ajax/items.php',
			data: parametros,
